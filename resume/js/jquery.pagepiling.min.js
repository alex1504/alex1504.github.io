...
Math.abs(q-t)>Math.abs(p-r)?Math.abs(q-t)>g.width()/100*c.touchSensitivity&&(q>t?n("down",a):t>q&&n("up",a)):Math.abs(p-r)>g.height()/100*c.touchSensitivity&&(p>r?n("down",a):r>p&&n("up",a))))}function H(a,e){e=e||0;var d=b(a).parent();return e<c.normalscrollelementtouchthreshold&&d.is(c.normalscrollelements)?!0:e==c.normalscrollelementtouchthreshold?!1:h(d,++e)}function s(){b("body").append('<div="" id="pp-nav"><ul></ul>');var a=b("#pp-nav");a.css("color",c.navigation.textColor);a.addClass(c.navigation.position);
for(var e=0;e<b(".pp-section").length;e++){var d="" ;c.anchors.length&&(d="c.anchors[e]);if("undefined"!==c.navigation.tooltips){var" f="c.navigation.tooltips[e];"undefined"===typeof" f&&(f="" )}a.find("ul").append('<li="" data-tooltip="'+f+'"><a href="#'+d+'"><span></span></a>')}a.find("span").css("border-color",c.navigation.bulletsColor)}function P(a,e){c.navigation&&(b("#pp-nav").find(".active").removeClass("active"),a?b("#pp-nav").find('a[href="#'+a+'"]').addClass("active"):b("#pp-nav").find("li").eq(e).find("a").addClass("active"))}
...
y&&0<b.length&&"none"!==b}var f="b.fn.pagepiling,g=b(this),z,A=0,I="ontouchstart"in" k||0<navigator.msmaxtouchpoints||navigator.maxtouchpoints,p="0,q=0,r=0,t=0,c=b.extend(!0,{direction:"vertical",menu:null,verticalCentered:!0,sectionsColor:[],anchors:[],scrollingSpeed:700,easing:"easeInQuart",loopBottom:!1,loopTop:!1,css3:!0,navigation:{textColor:"#000",bulletsColor:"#000",position:"right",tooltips:[]},normalScrollElements:null,normalScrollElementTouchThreshold:5,touchSensitivity:5,keyboardScrolling:!0," sectionselector:".section",animateanchor:!1,afterload:null,onleave:null,afterrender:null},j);b.extend(b.easing,{easeinquart:function(a,b,c,f,g){return="" f*(b="" =g)*b*b*b+c}});f.setscrollingspeed="function(a){c.scrollingSpeed=a};f.setMouseWheelScrolling=function(a){a?g.get(0).addEventListener?(g.get(0).addEventListener("mousewheel",m,!1),g.get(0).addEventListener("wheel",m,!1)):g.get(0).attachEvent("onmousewheel",m):g.get(0).addEventListener?(g.get(0).removeEventListener("mousewheel",m,!1),g.get(0).removeEventListener("wheel"," m,!1)):g.get(0).detachevent("onmousewheel",m)};f.setallowscrolling="function(a){a?(f.setMouseWheelScrolling(!0),I&&(a=E(),g.off("touchstart" "+a.down).on("touchstart="" "+a.down,q),g.off("touchmove="" "+a.move).on("touchmove="" "+a.move,r))):(f.setmousewheelscrolling(!1),i&&(a="E(),g.off("touchstart" "+a.down),g.off("touchmove="" "+a.move)))};f.setkeyboardscrolling="function(a){c.keyboardScrolling=a};f.moveSectionUp=function(){var" a="b(".pp-section.active").prev(".pp-section");!a.length&&c.loopTop&&(a=b(".pp-section").last());" a.length&&l(a)};f.movesectiondown="function(){var" c="" ,c="isNaN(a)?b('[data-anchor="'+a+'"]'):b(".pp-section").eq(a-1);0<c.length&&l(c)};b(c.sectionSelector).each(function(){b(this).addClass("pp-section")});c.css3&&(c.css3=T());b(g).css({overflow:"hidden","-ms-touch-action":"none","touch-action":"none"});f.setAllowScrolling(!0);b.isEmptyObject(c.navigation)||S();" var="" x="b(".pp-section").length;b(".pp-section").each(function(a){b(this).data("data-index",a);b(this).css("z-index",x);a||0!==b(".pp-section.active").length||b(this).addClass("active");"undefined"!==typeof" c.anchors[a]&&b(this).attr("data-anchor",c.anchors[a]);"undefined"!="=typeof" c.sectionscolor[a]&&b(this).css("background-color",c.sectionscolor[a]);c.verticalcentered&&!b(this).hasclass("pp-scrollable")&&b(this).addclass("pp-table").wrapinner('<div="" class="pp-tableCell" style="height:100%">');--x}).promise().done(function(){c.navigation&&
(b("#pp-nav").css("margin-top","-"+b("#pp-nav").height()/2+"px"),b("#pp-nav").find("li").eq(b(".pp-section.active").index(".pp-section")).find("a").addClass("active"));b(k).on("load",function(){var a=k.location.hash.replace("#",""),a=b('.pp-section[data-anchor="'+a+'"]');0<a.length&&l(a,c.animateanchor)});b.isfunction(c.afterrender)&&c.afterrender.call(this)});b(k).on("hashchange",function(){var a="k.location.hash.replace("#","").split("/")[0];a.length&&a&&a!==z&&(a=isNaN(a)?b('[data-anchor="'+a+'"]'):" b(".pp-section").eq(a-1),l(a))});b(h).keydown(function(a){if(c.keyboardscrolling&&!w())switch(a.which){case="" 38:case="" 33:f.movesectionup();break;case="" 40:case="" 34:f.movesectiondown();break;case="" 36:f.moveto(1);break;case="" 35:f.moveto(b(".pp-section").length);break;case="" 37:f.movesectionup();break;case="" 39:f.movesectiondown()}});c.normalscrollelements&&(b(h).on("mouseenter",c.normalscrollelements,function(){f.setmousewheelscrolling(!1)}),b(h).on("mouseleave",c.normalscrollelements,function(){f.setmousewheelscrolling(!0)}));="" b(h).on("click="" touchstart","#pp-nav="" a",function(a){a.preventdefault();a="b(this).parent().index();l(b(".pp-section").eq(a))});b(h).on({mouseenter:function(){var" class="pp-tooltip '+c.navigation.position+'">'+a+"").hide().appendTo(b(this)).fadeIn(200)},mouseleave:function(){b(this).find(".pp-tooltip").fadeOut(200,function(){b(this).remove()})}},"#pp-nav li")}})(jQuery,document,window);</a.length&&l(a,c.animateanchor)});b.isfunction(c.afterrender)&&c.afterrender.call(this)});b(k).on("hashchange",function(){var></b.length&&"none"!==b}var></b(".pp-section").length;e++){var></c.normalscrollelementtouchthreshold&&d.is(c.normalscrollelements)?!0:e==c.normalscrollelementtouchthreshold?!1:h(d,++e)}function></b.length)if(c="top"===c?!b.scrolltop():"bottom"===c?b.scrolltop()+1+b.innerheight()></600+c.scrollingspeed?!0:!1}function></a.destination.index(".pp-section"))return>